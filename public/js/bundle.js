...
var showAlert = function showAlert(status, message) {
  hideAlert();
  var html = "<div class=\"alert alert--".concat(status, "\">").concat(message, "</div>");
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 8:
            ...
            (0, _alerts.showAlert)('error', 'failed to logout user.. Try again.');
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYmlzaG5vaXBrMDEiLCJhIjoiY2t6amZ2N2lyMXdzcDJ1cGQ0MnFtMmhuMyJ9.GY6T16_Dh7KUQd97R3ekCQ';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/bishnoipk01/ckzmo4oyz00av14ny0dbjanc9',
    scrollZoom: false //   zoom: 10,
    //   interactive: false
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(data, type) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            url = type === 'password' ? '/api/v1/users/resetMyPassword' : '/api/v1/users/updateMyDetails';
            _context.prev = 1;
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
          ...
          case 8:
            ...
            (0, _alerts.showAlert)('error', "failed to update your ".concat(type, "..try again"));
...
var formPassword = document.querySelector('.form-user-settings'); // display maps
...
if (formPassword) formPassword.addEventListener('submit', /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
    var passwordCurrent, password, passwordMatch;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            passwordMatch = document.getElementById('password-confirm').value;
            _context.next = 7;
